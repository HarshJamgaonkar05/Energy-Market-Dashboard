...
export const ENDPOINT_SOURCES = {
  ...
  "/api/regime/current": { source: "regime", mixed: ["dataset", "eia"] },
  "/api/regime/catalog": { source: "regime", mixed: ["dataset", "eia"] },
  "/api/regime/history": { source: "regime", mixed: ["dataset", "eia"] },
